...
long disjoint_end_fubar = 0;
long conjoint_fubar = 0;
long conjoint_end_fubar = 0;
long fubar = 0;
long prolog_fubar = 0;
long store_fubar = 0;
long add_fubar = 0;
...
static void store_barrier_buffer_add(MacroAssembler* masm,
  ...
  //__ z_ldgr(Z_F3, Z_R1);
  //__ load_const_optimized(Z_R1, (uintptr_t)&idk_fubar);
  //__ z_agsi(0, Z_R1, 1);
  //__ z_lgdr(Z_R1, Z_F3);
...
void ZBarrierSetAssembler::copy_load_at(MacroAssembler* masm, Register zpointer, Address src) {
  Label load_done;
